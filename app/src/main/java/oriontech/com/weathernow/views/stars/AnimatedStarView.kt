package oriontech.com.weathernow.views.stars
...
import oriontech.com.weathernow.R
import oriontech.com.weathernow.views.stars.model.InterstellarFactory
import oriontech.com.weathernow.views.stars.model.Star
import oriontech.com.weathernow.views.stars.model.StarConstraints
import oriontech.com.weathernow.views.stars.model.meteor.Meteorite
...
constructor(
    ...
    private lateinit var starColors: IntArray
    private lateinit var meteoritesColors: IntArray
    ...
    init {
        ...
        val array = context.obtainStyledAttributes(attrs, R.styleable.AnimatedStarView, defStyleAttr, 0)


        starCount = array.getInt(R.styleable.AnimatedStarView_starsView_starCount, defaultStarCount)
        minStarSize = array.getDimensionPixelSize(R.styleable.AnimatedStarView_starsView_minStarSize, 4)
        maxStarSize = array.getDimensionPixelSize(R.styleable.AnimatedStarView_starsView_maxStarSize, 24)
        bigStarThreshold = array.getDimensionPixelSize(R.styleable.AnimatedStarView_starsView_bigStarThreshold, Integer.MAX_VALUE)
        starConstraints = StarConstraints(minStarSize, maxStarSize, bigStarThreshold)


        meteoritesEnabled = array.getBoolean(R.styleable.AnimatedStarView_starsView_meteoritesEnabled, false)
        meteoritesInterval = array.getInt(R.styleable.AnimatedStarView_starsView_meteoritesInterval, 5000)

        val starColorsArrayId = array.getResourceId(R.styleable.AnimatedStarView_starsView_starColors, 0)
        val meteoritesColorsArrayId = array.getResourceId(R.styleable.AnimatedStarView_starsView_meteoritesColors, 0)
